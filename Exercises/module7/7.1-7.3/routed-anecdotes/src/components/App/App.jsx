...
import ViewOneAnecdote from 'components/Anecdotes/ViewOneAnecdote'
...
const App = () => {
  ...
  const addNew = (anecdote) => {
    console.log('ici on rentre dans addNew');
  ...
  return (
    <div>
      ...
      <Routes>
        ...
        <Route path="/anecdotes/:id" element={<ViewOneAnecdote {...{ anecdote }} />} />
      </Routes>
      <Footer />
    </div>
  );
